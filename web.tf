...
resource "aws_s3_bucket" "demonewbucketxxzzyy" {
  bucket = "demonewbucketxxzzyy"
...
resource "aws_s3_bucket_public_access_block" "public_storage" {
 depends_on = [aws_s3_bucket.demonewbucketxxzzyy]
 bucket = "demonewbucketxxzzyy"
...
resource "aws_cloudfront_distribution" "tera-cloufront1" {
    ...
    origin {
        domain_name = aws_s3_bucket.demonewbucketxxzzyy.bucket_regional_domain_name
